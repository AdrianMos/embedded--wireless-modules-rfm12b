...
else return DATA_EROARE_DUBLA;

}

/*
///////////////////////////// DATA_decode_and_combine (u8 in1, u8 in2, u8 *out1) ///////
//decodare Huffman a datelor
//decodeaza 2*8 biti in 2*4 biti de informatie utila
//combina cele 2 grupe de catre 4 biti de informatie
//returneaza 1 - succes      0 - esec
u8 DATA_decode_and_combine(u8 in1, u8 in2, u8 *out)
{

u8 out1, out2;

DATA_decode(in1, &out1);
DATA_decode(in2, &out2);


if((out1!=DATA_EROARE_DUBLA) && (out2!=DATA_EROARE_DUBLA)) //nu exista erori
{
 out1 = out1<<4;    //deplasare cu 4 biti spre stanga a lui out1 => b0b1b2b3 0 0 0 0
 out1 = out1 | out2;//combinarea grupelor de 4 biti              => b0b1b2b3b4b5b6b7
...
/*
///////////////////////////// DATA_spit_and_code (u8 in1, u8 in2, u8 *out1) ///////
//codare Huffman a datelor
//codeaza 8 biti de informatie in 2*8 biti
void DATA_split_and_code(u8 in, u8 *out1, u8 *out2)
{
DATA_code((in & 0xF0)>>4, out1);
DATA_code(in & 0x0F     , out2);
}
*/
